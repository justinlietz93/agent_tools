...
class OllamaWrapper(OpenAICompatibleWrapper):
    ...
    def _parse_json_relaxed(self, text: str) -> Dict[str, Any]:
        ...
        - Fallback to NDJSON: decode each non-empty line and keep the last object WITH 'message'
        ...
        # NDJSON fallback (prefer lines that carry a 'message' key; Ollama streams end with {"done": true})
        last_obj: Dict[str, Any] | None = None
        last_msg_obj: Dict[str, Any] | None = None
    ...
    def execute(self, user_input: str) -> str:
        ...
        try:
            ...
            # Prefer content from Ollama /api/chat; fallback to OpenAI-compatible shapes
            ...
            if tool_call:
                ...
                # No tool call found, return content as normal conversational response (de-duplicate reasoning vs response)
